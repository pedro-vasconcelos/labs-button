 ...
 */
export function getValueByPath(nestedObj: any, path: string, defaultValue = undefined): any {
// console.log('----------------------- START: getValueByPath -----------------------')
// console.info(nestedObj, path, defaultValue)
// console.info(path.split('.'))
    const value = path.split('.').reduce(
        (obj, key) => {
            // console.log('obj:', obj)
            // console.log('key: ', key)
            // console.log("typeof obj !== 'undefined' ? obj[i] : undefined: ", typeof obj !== 'undefined' ? obj[key] : undefined)
            return typeof obj !== 'undefined' ? obj[key] : undefined
        }
        ,nestedObj)
// console.log('value: ' + value)
// console.log('----------------------- END: getValueByPath -----------------------')
